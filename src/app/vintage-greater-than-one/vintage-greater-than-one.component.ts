...
@Component({
  selector: 'app-vintage-greater-than-one',
  templateUrl: './vintage-greater-than-one.component.html',
  styleUrls: ['./vintage-greater-than-one.component.css']
})
export class VintageGreaterThanOneComponent implements OnInit {

  projectName = sessionStorage.getItem('projectName') as any;
  projectName_plural = sessionStorage.getItem('projectName_plural') as any;

  first_triggerDate = this.common.getTriggerDate().fstTrigDateGt1
  last_triggerDate = this.common.getTriggerDate().lstTrigDateGt1
  ...
  constructor(private rest: RestApiService, private ngxService: NgxUiLoaderService, private notifier: NotifierService, private modalService: NgbModal, private common: CommonService) {
    sessionStorage.setItem("triggerTrackerPage", '2');
   }
  ngOnInit(): void {
    // this.triggerImpact();
  ...
  subChannelDegrowGraph() {
    ...
    this.rest.subChannelDegrowGraphGt1(data).subscribe((res: any) => {
      if (res.success) {
        var topLables = {
          id: 'topLables',
  ...
  underPerformingGraphZh() {
    ...
    this.rest.underPerformGraphZhGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  underPerformingGraphCh() {
    ...
    this.rest.underPerformGraphChGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  underPerformingGraphRm() {
    ...
    this.rest.underPerformGraphRmGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  mtdDowntrendGraphZh() {
    ...
    this.rest.mtdDowntrendGraphZhGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  mtdDowntrendGraphCh() {
    ...
    this.rest.mtdDowntrendGraphChGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  mtdDowntrendGraphRm() {
    ...
    this.rest.mtdDowntrendGraphRmGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  //     user_agent_id: this.user_agent_id,
  //   }
  //   this.rest.singleChannelGraph().subscribe((res: any) => {
  //     if (res.success) {
  ...
  getPriorityCount() {
    this.rest.getPriorityCountGt1().subscribe((res: any) => {
      if (res.success) {
  ...
  downloadThreeMonthImds() {
    ...
    this.rest.p1For3MntXcelGt1().subscribe((res: any) => {
      if (res.success) {
  ...
  downloadTwoMonthImds() {
    this.ngxService.start();
    this.rest.p2For2MntXcelGt1().subscribe((res: any) => {
      if (res.success) {
        this.ngxService.stop();
        let fileName = res.filename
        window.open(this.rest.file_path + '/downloads/' + fileName)
  ...
  downloadOneMonthImds() {
    this.rest.p3For1MntXcelGt1().subscribe((res: any) => {
      this.ngxService.start();
      if (res.success) {
        this.ngxService.stop();
        let fileName = res.filename
  ...
  // triggerImpact(){
  //   this.rest.triggerImpactGt1().subscribe((res: any) => {
  //     if (res.success) {
  ...
  triggerImpact(){
    this.rest.triggerImpact_gt1().subscribe((res: any) => {
      if (res.success) {
  ...
  agent_degrowth_priority_wise(){
    this.rest.agent_degrowth_priority_wise_gt1().subscribe((res: any) => {
      if (res.success) {
  ...
  triggerPerformance() {
    ...
    this.rest.trigPerformGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  //             // ctx.fillText(datapoint, x.getPixelForValue(index), chart.getDatasetMeta(0).data[index].y + 10);
  //             // ctx.align = 'justyfy'
  //             ctx.fillText(datapoint, x.getPixelForValue(index)-50, chart.getDatasetMeta(0).data[index].y - 10);
  //           });
  ...
  //             ctx.fillText(datapoint , x.getPixelForValue(index)-15, chart.getDatasetMeta(1).data[index].y - 10);
  //           });
  ...
  //             ctx.fillText(datapoint, x.getPixelForValue(index)+50, chart.getDatasetMeta(3).data[index].y - 10);
  //           });
  ...
  threeMonthsGwpGraph(){
    this.rest.threeMonthsGwpGraph_gt1().subscribe((res: any) => {
      if (res.success) {
    var topLables = {
      id: 'topLables',
      afterDatasetsDraw: (chart: any, args: any, options: any) => {
  ...
  //  }
   ...
   actImdsDownload(){
    ...
    this.ngxService.start();
    this.rest.actImdsDownloadGt1(data).subscribe((res: any) => {
      if (res.success) {
        this.ngxService.stop();
        let fileName = res.filename
        window.open(this.rest.file_path + '/downloads/' + fileName)
   ...
   subChannelwiseTotal(){
    ...
    this.rest.subChannelwiseTotalGt1(data).subscribe((res: any) => {
      if (res.success) {
  ...
  //       this.overAllAgents = res.count_of_agents_gt_1;
  //       this.degrowingAgents = res.count_of_agents_gt_1_degrowing;
  //       this.cylmtd = res.prev_month_gt_1_mtd;
  //       this.mtd = res.current_month_gt_1_mtd;
              ...
              plugins: {
                ...
                tooltip: {
                  callbacks: {
                    title: function (context) {
                      // return res.zhNamesList[context[0].dataIndex].toString().replaceAll(',', ' ');
                      // return this.splitStringsBySpaces(x_axis_cat_List)[context[0].dataIndex].toString().replaceAll(',', ' ');
